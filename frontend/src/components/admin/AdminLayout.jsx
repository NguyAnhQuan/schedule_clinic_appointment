import { getAuthToken, setAuthToken, setAuthUser } from '../../services/api';
      ...
      <aside className="hidden md:flex w-64 bg-white border-r border-slate-200 flex-col h-screen">
        ...
        <div className="p-4 border-t border-slate-100 flex flex-col gap-3">
          ...
          <div className="flex items-center gap-3">
            <img
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuBPv-wodTXjcMzk5BbV4rICFCvyQxIKTY6p5fXkh9iq3O2jHtLnoCm6jfiCay2yLpFVh7bsXwBjFGRiud2TWYsKDzwx3RBGt9SoBYpTSZCMRrESJCoOymThiF-TWhJ5mdMN9I7M_zh0Dk_yR83eFmdq5LXe5AWP7uLpPptZ1ozoVSxLG-q7jLxLBt4rnplMgDvgC9aakeEcdlqAzRbHOaKp7UMnhDUDYi5BhUU1_GwhyuBIWGkESOvpt-eSnEX9AcUGKwVae1-tqJY"
            alt="Admin profile"
            className="w-10 h-10 rounded-full object-cover border-2 border-slate-100"
            />
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-slate-900 truncate">
                {isAuthed ? 'Admin' : 'Guest'}
              </p>
              <p className="text-xs text-slate-500 truncate">
                {isAuthed ? 'Clinic Management' : 'Not signed in'}
              </p>
            </div>
            <a
            href="/admin/login"
